...
const javaSourcePath = path.join(fixtureDir, "java", "AcademicHellPdfFixtureCli.java");
const javaClassPath = path.join(buildDir, "AcademicHellPdfFixtureCli.class");
